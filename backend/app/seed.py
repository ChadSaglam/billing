...
def seed_services(db: Session, tenant_id: int) -> int:
    services = [
        ...
        ServiceTemplate(
            ...
            category="Development",
            description="Custom software and business application development",
            unit="Stunde",
            default_price=Decimal("250.00"),
            sort_order=3,
        ),
        ...
        ServiceTemplate(
            ...
            name="Web Design",
            category="Development",
            description="UI/UX design and visual branding for web",
            unit="Stunde",
            default_price=Decimal("250.00"),
            sort_order=5,
        ),
        ServiceTemplate(
            ...
            name="IT Consulting",
            category="Consulting",
            description="Strategic IT guidance, technology selection and planning",
            unit="Stunde",
            default_price=Decimal("250.00"),
            sort_order=1,
        ),
        ServiceTemplate(
            ...
            category="Consulting",
            description="Ongoing technical customer support",
            unit="Stunde",
            default_price=Decimal("250.00"),
            sort_order=2,
        ),
        ServiceTemplate(
            ...
            name="System Update",
            category="Consulting",
            description="Software and system updates and maintenance",
            unit="Stunde",
            default_price=Decimal("250.00"),
            sort_order=3,
        ),
        ServiceTemplate(
            ...
            category="Data & AI",
            description="Data analysis, trend identification and dashboard creation",
            unit="Stunde",
            default_price=Decimal("250.00"),
            sort_order=1,
        ),
        ServiceTemplate(
            ...
            name="AI Services",
            category="Data & AI",
            description="AI integration, machine learning solutions and automation",
            unit="Stunde",
            default_price=Decimal("250.00"),
            sort_order=2,
        ),
        ServiceTemplate(
            ...
            description="ERP configuration and business process automation",
            unit="Stunde",
            default_price=Decimal("250.00"),
            sort_order=1,
        ),
        ServiceTemplate(
            ...
            name="Web Hosting",
            category="Infrastructure",
            description="Reliable web hosting with technical support",
            unit="Monat",
        ...
        ServiceTemplate(
            ...
            category="Infrastructure",
            description="MDM setup, security policies and device management",
            unit="Stunde",
            default_price=Decimal("250.00"),
            sort_order=3,
        ),
        ServiceTemplate(
            ...
            category="Infrastructure",
            description="Hardware solutions for data processing and expansion",
            unit="Stück",
        ...
        ServiceTemplate(
            ...
            category="Infrastructure",
            description="HD security camera installation and configuration",
            unit="Stück",
