...
// The e2e stack lives on its own ports (5150 frontend / 9100 API) so it can
// run next to a dev stack on 5050 / 9000 without either colliding. The root
...
const E2E_FRONTEND_PORT = process.env.E2E_FRONTEND_PORT || '5150';
